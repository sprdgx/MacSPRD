...
export default function Login(props: MacActions) {
  ...
  return (
    <div
      className="w-full h-full login text-center relative"
      style={{
        position: "relative"
      }}
      onClick={() => loginHandle()}
    >
      ...
      <img
        ...
        src={dark ? wallpapers.night : wallpapers.day}
        alt="Wallpaper"
      />
      ...
      <div className="inline-block w-auto relative top-1/2 -mt-40 z-10">
        {/* Avatar */}
        <img
      ...
      {/* buttons */}
      <div className="text-sm fixed bottom-16 left-0 right-0 mx-auto flex flex-row space-x-4 w-max z-10">
        <div
